...
<tr class="h-18 border-b border-coolGray-100">
    <th class="whitespace-nowrap px-4 bg-white text-left">
        <div class="flex items-center -m-2">
            ...
            <div class="w-auto p-2">
                ...
                <p class="text-xs font-medium text-coolGray-500">#LOKASI#</p>
            </div>
        </div>
    </th>
    ...
    <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-500 text-left">#JAMOPERASI#</th>
    <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-#col#-500 text-left">#KARYA#</th>
    <th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-#col#-500 text-left">#SENIMAN#</th>
    <th class="whitespace-nowrap px-4 bg-white text-left">
        <div class="w-auto p-2">
        <p class="text-xs font-semibold text-coolGray-800">#DESKRIPSIKARYA#</p>
        <p class="text-xs font-medium text-coolGray-500">#TAHUN#</p>
        </div>
    </th>
